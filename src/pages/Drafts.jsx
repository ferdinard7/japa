...
const Drafts = ({ token }) => {
  ...
  const main_token = cookies.AuthToken;
  ...
  const handleDeleteDraft = async (id) => {
    ...
    // Update the drafts state by filtering out the deleted draft
    setDrafts(prevDrafts => prevDrafts.filter(draft => draft.draft_id !== id));
